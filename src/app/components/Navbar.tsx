...
const links: Navlink[] = [
    {path: "/", icon: <HiHome  size={20}/>, name: "Home"},
    {path: "/about", icon: <MdPerson4 size={20} />, name: "About" },
    {path: "/projects", icon: <LuConstruction size={20} />, name: "Projects" },
    {path: "/contact", icon: <MdEmail size={20} />, name: "Contact" },
    {path: "/blogs", icon: <RiArticleFill size={20} />, name: "Blogs" }
];
                    ...
                    {links.map((link) => (
                        <li key={link.name}>
                            <Link href={link.path} passHref>
                                <div className={`cursor-pointer hover:text-purple-700 duration-150 transition-colors relative`}>
                                    {link.icon}
                                </div>
                            </Link>
                        </li>
